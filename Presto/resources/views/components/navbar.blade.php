<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid ms-5">
      <a class="navbar-brand tre ms-5 fs-1" href="{{route('homepage')}}"><i class="tre fs-3 ms-5 fas fa-bullhorn"></i> <b> Presto.it </b></a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
          @guest
            ...
            @else
            <li class="nav-item ms-3">
              <a class="nav-link tre login fs-5" href="{{route('announcement.index')}}"><i class="fas me-2 fs-5 fa-archive"></i> I miei annunci </a>
            </li>
            <li class="nav-item ms-3">
