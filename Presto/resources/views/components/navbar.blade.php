<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid ms-5">
        <a class="navbar-brand nav-link ms-5 fs-1" href="{{ route('homepage') }}"><i
                class="fs-3 ms-5 fas fa-bullhorn"></i> <b> Presto.it </b></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item flag-icon-it mx-2 mt-4">
                    @include('components._locale',['lang'=>'it','nation'=>'it'])AAA</li>
                <li class="nav-item flag-icon-en mx-2 mt-4">
                    @include('components._locale',['lang'=>'en','nation'=>'gb'])AAA</li>
                <li class="nav-item flag-icon-es mx-2 mt-4">
            ...
            @guest
                <li class="nav-item ms-3">
                    <a class="nav-link tre fs-5" href="{{ route('login') }}"><i
                            class="fs-5 me-2 fas fa-sign-in-alt"></i>{{ __('ui.login') }}</a>
                </li>
                <li class="nav-item ms-3">
                    <a class="nav-link tre fs-5 " href="{{ route('register') }}"><i
                            class="fs-5 me-2 fas fa-clipboard-check"></i>{{ __('ui.register') }}</a>
                </li>
                <li class="nav-item ms-3">
                    <a class="nav-link tre fs-5 " href="{{ route('announcement.index') }}"><i
                            class="fas fs-5 me-2 fa-pager"></i>{{ __('ui.announcements') }}</a>
                </li>
                <li class="nav-item ms-3">
            ...
            @else
                <li class="nav-item ms-3">
                    <a class="nav-link login fs-5" href="{{ route('announcement.index') }}"><i
                            class="fas me-2 fs-5 fa-archive"></i>{{ __('ui.announcements') }}</a>
                </li>
                <li class="nav-item ms-3">
